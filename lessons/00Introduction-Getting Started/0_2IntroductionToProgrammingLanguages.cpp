...
int main(void)
{
    std::cout << "I know what a program is, wasted my time." << std::endl;
    std::cout << "Different CPU architecture, different instruction sets. ARM is going to crush x86." << std::endl;
